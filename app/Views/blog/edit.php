    ...
    <div class="container mt-4">
        ...
        <form action="<?= base_url("blog/update/{$blog['id']}") ?>" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="judul" name="judul" value="<?= esc($blog['judul']) ?>" required>
            </div>

            <div class="form-group">
                <label for="keterangan">Description:</label>
                <textarea class="form-control" id="keterangan" name="keterangan" rows="4" required><?= esc($blog['keterangan']) ?></textarea>
            </div>
