...
<section class="create_source_code_section layout_padding">
    <div class="container">
    <h1>Tambah Postingan Source code</h1>
        <p>Tambahkan  /akses untuk  tidak mengizinkan download</p>
        <?php echo form_open_multipart('source_code/store'); ?>
        ...
        <div class="form-group">
            ...
            <input type="text" name="live_preview" class="form-control" required>
        </div>
...
<!-- End Create Source Code Section -->
