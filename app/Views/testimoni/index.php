...
<section class="testimoni_list_section layout_padding">
    <div class="container">
        <h1>Testimoni</h1>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($t['foto'] && file_exists('images/' . $t['foto'])): ?>
                                <img src="/images/<?= $t['foto']; ?>" alt="Foto" style="max-width: 100px;">
                            <?php else: ?>
                                No Image
                            <?php endif; ?>
                        </td>
                        <td><?= $t['keterangan']; ?></td>
                        <td>
                            <a href="/testimoni/edit/<?= $t['id']; ?>" class="btn btn-warning">Edit</a>
                            <a href="/testimoni/delete/<?= $t['id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this testimonial?')">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
